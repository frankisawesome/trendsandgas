...
const App = () => {
  ...
  return (<div className="w-full flex flex-col items-center">
    ...
    <div className="max-w-xl w-full md:w-3/5 flex flex-col items-center mt-10">
      ...
      />
      <div>
        <button className="bg-red-400 shadow-xl text-white rounded px-4 py-2 focus:outline-none focus:bg-red-200 hover:bg-white hover:border-red-400 hover:text-red-400 mt-10 mx-6">gaaaas?</button>
